...
public class Main2 {
    ...
    public final static Logger log = LogManager.getLogger(Main2.class.getName());
//    static Logger logs = Logger.getLogger(Main.class.getName());
    ...
    public final static void addUser(Library l, Scanner scan) throws InvalidNumberException {
